...
// Engine RPM range (2 for locomotive, 4 for fast running morors
const uint32_t TOP_SPEED_MULTIPLIER = 3; // RPM multiplier: the bigger the number, the larger the rev range, 2 - 5 is a good place to start. ESP32 will crash, if > 5 @ 22'050Hz!

// Engine mass simulation
const int8_t acc = 5; // Acceleration step (4) 2 = slow for locomotive engine, 9 = fast for trophy truck
const int8_t dec = 3; // Deceleration step per (2) 1 = slow for locomotive engine, 5 = fast for trophy truck
