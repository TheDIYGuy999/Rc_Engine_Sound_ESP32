...
#include "sounds/TankStart3.h" // V12 tank start sound

// Choose the motor idle sound (uncomment the one you want) --------
volatile int idleVolumePercentage = 50; // Adjust the idle volume (usually = 100%, more also working, depending on sound, 50 - 60% if additional diesel knock sound is used)
...
//#include "sounds/Cat3406BIdle.h" // NO Caterpillar 3406B idle (Volume 100%, 35%, Turbo 70%, 10%, Wastegate 30%, 1%, CEP 100, TSM 3)
...
#include "sounds/Tankmotorsound.h" // V12 tank idle sound  
