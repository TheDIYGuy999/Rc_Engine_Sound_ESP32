 ...
 */
uint8_t neopixelMode = 2;

// These light options are adjustabale during compile time only ---------------------------------------------------------------------------------------------
...
bool indicatorsAsSidemarkers = false; // The indicators are used as side markers as well. This is commonly used in US trucks.
