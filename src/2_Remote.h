...
#define PS3_GAMEPAD                // <------- PS3 Bluetooth Gamepad remote . Don't use this with standard remotes!
// For testing only!
...
// "PS3 Bluetooth Gamepad" for PS3 Bluetooth Gamepad remote configuration profile -------------------------------------------------------------------------------------------
#ifdef PS3_GAMEPAD
