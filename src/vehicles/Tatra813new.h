...
#include "sounds/Tatra813start.h" // Tatra 813 8x8 air cooled V12 Diesel
...
//#include "sounds/Tatra813Idle.h" // Tatra 813 8x8 air cooled V12 Diesel
//#include "sounds/Tara813newIdle.h" // Tatra 813 8x8 air cooled V12 Diesel
//#include "sounds/Tatra813idle2.h" // Tatra 813 8x8 air cooled V12 Diesel
#include "sounds/Tatra813idle3.h" // Tatra 813 8x8 air cooled V12 Diesel
//#include "sounds/Tatra813idle4.h" // Tatra 813 8x8 air cooled V12 Diesel
...
volatile const uint16_t revSwitchPoint = 0; // The rev sound is played instead of the idle sound above this point
...
#ifdef REV_SOUND
//#include "sounds/Tara813newHighRev.h" // Tatra 813 8x8 air cooled V12 Diesel
//#include "sounds/Tara813newRev.h" // Tatra 813 8x8 air cooled V12 Diesel
//#include "sounds/Tatra813rev.h" // Tatra 813 8x8 air cooled V12 Diesel
#include "sounds/Tatra813rev3.h" // Tatra 813 8x8 air cooled V12 Diesel
//#include "sounds/Tatra813rev4.h" // Tatra 813 8x8 air cooled V12 Diesel
#endif
...
#include "sounds/Tatra813jakeBrake.h" // Tatra 813 8x8 air cooled V12 Diesel
#endif
...
volatile int dieselKnockVolumePercentage = 40; // Adjust the Diesel knock volume (usually = 40 - 120%)
...
//#include "sounds/Tara813newKnock.h" // Tatra 813 8x8 air cooled V12 Diesel
//#include "sounds/Tara813newKnock2.h" // Tatra 813 8x8 air cooled V12 Diesel
#include "sounds/Tatra813knock3.h" // Tatra 813 8x8 air cooled V12 Diesel
...
volatile int fanVolumePercentage = 30; // Adjust the fan volume (50% for Tatra 813, else 0%)
volatile int fanIdleVolumePercentage = 10; // the fan volume will be engine rpm dependent (usually = 10%)
volatile int fanStartPoint = 300; // Volume will raise above this point (250 for Tatra 813)
...
volatile int hornVolumePercentage = 144; // Adjust the horn volume (usually = 80%)
