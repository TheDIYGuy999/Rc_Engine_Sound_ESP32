...
volatile int fanVolumePercentage = 150; // Adjust the fan volume (250% for Tatra 813, else 0%)
...
volatile int hornVolumePercentage = 180; // Adjust the horn volume (usually = 100%)
