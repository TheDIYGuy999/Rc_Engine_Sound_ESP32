...
#include "sounds/MagirusMercur125Idle.h" // Magirus Mercur 125
...
#ifdef REV_SOUND
//#include "sounds/MagirusMercur125Rev.h" // Magirus Mercur 125
#include "sounds/MagirusMercur125Rev2.h" // Magirus Mercur 125
#endif
...
volatile int jakeBrakeVolumePercentage = 120; // Adjust the max. volume (usually = 150%)
...
#include "sounds/MagirusMercur125JakeBrake.h" // Magirus Mercur 125
#endif
...
volatile int dieselKnockVolumePercentage = 120; // Adjust the Diesel knock volume (usually = 40 - 120%) 850
...
uint16_t knockStartRpm = 20; // starting @ this RPM (about 50 - 400)
#endif // ********************************************************************************
#include "sounds/MagirusMercur125Knock2.h" // Magirus Mercur 125
...
volatile int wastegateVolumePercentage = 30; // Adjust the wastegate volume (usually = 14%, up to 50%)
...
volatile int brakeVolumePercentage = 28; // Adjust the brake volume (usually = 40%)
...
volatile int parkingBrakeVolumePercentage = 26; // Adjust the brake volume (usually = 40%)
...
uint32_t MAX_RPM_PERCENTAGE = 260; // NOTE! Was called TOP_SPEED_MULTIPLIER (TSM) in earlier versions and was a multiplier instead of a percentage!
