...
#include "sounds/MANTGXstart.h" // MAN TGX 680
...
#include "sounds/MANTGXidle.h" // MAN TGX 680
...
#ifdef REV_SOUND
#include "sounds/MANTGXrev.h" // MAN TGX 680
#endif
...
#include "sounds/MANTGXjakebrake2.h" // MAN TGX 680
#endif
...
volatile int dieselKnockAdaptiveVolumePercentage = 15; // Adjust the Diesel knock volume for the non-first knocks per engine cycle (usually = 50%)
#include "sounds/MANTGXknock2.h" // MAN TGX 680
...
#include "sounds/MANTGXwastegate2.h" // MAN TGX 680
...
#include "sounds/MANTGXshifting.h" // Pneumatic shifting sound
