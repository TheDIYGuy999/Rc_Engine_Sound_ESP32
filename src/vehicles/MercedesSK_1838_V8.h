...
//#include "sounds/Scania143start4.h" // SCANIA V8
#include "sounds/Mercedes_SK_1838_V8_Start.h" // Mercedes SK 1838 V8
...
#include "sounds/Mercedes_SK_1838_V8_Idle3.h" // Mercedes SK 1838 V8
...
volatile const uint16_t revSwitchPoint = 10; // The rev sound is played instead of the idle sound above this point 150
...
#ifdef REV_SOUND
#include "sounds/Mercedes_SK_1838_V8_Rev2.h" // Mercedes SK 1838 V8
#endif
...
#include "sounds/Mercedes_SK_1838_V8_JakeBrake.h" // Mercedes SK 1838 V8
#endif
...
#include "sounds/Mercedes_SK_1838_V8_Knock4.h" // Mercedes SK 1838 V8

// Adjust the additional turbo sound (set "turboVolumePercentage" to "0", if you don't want it) --------
volatile int turboVolumePercentage = 5; // Adjust the turbo volume (usually = 70%)
...
volatile int hydraulicFlowVolumePercentage = 5; // Adjust the volume (usually = 20%)
...
uint32_t MAX_RPM_PERCENTAGE = 240; // NOTE! Was called TOP_SPEED_MULTIPLIER (TSM) in earlier versions and was a multiplier instead of a percentage! 206
