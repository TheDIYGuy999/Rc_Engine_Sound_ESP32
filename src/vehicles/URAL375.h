...
#include "sounds/Ural375Dstart2.h" // Ural 375D
//#include "sounds/Урал375start.h" // Ural 375D
...
volatile int revVolumePercentage = 120; // Adjust the idle volume (usually = 80%, more also working, depending on sound) 120
...
volatile int dieselKnockVolumePercentage = 60; // Adjust the Diesel knock volume (usually = 40 - 120%)
...
volatile int fanVolumePercentage = 0; // Adjust the fan volume (50% for Tatra 813, else 0%) 8
