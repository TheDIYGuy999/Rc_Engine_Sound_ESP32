...
volatile int dieselKnockVolumePercentage = 100; // Adjust the Diesel knock volume (usually = 40 - 120%)
...
volatile int fanVolumePercentage = 50; // Adjust the fan volume (50% for Tatra 813, else 0%)
