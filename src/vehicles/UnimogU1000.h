...
#include "sounds/UnimogU1000Door.h" // Unimog U1000 Turbo
...
const boolean doubleFlashBlueLight = false; // double flash blue lights if "true", "rotating" beacons if "false"
