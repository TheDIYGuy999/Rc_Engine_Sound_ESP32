...
#include "sounds/POWERSTROKEidle.h" // Ford Powerstroke 7.3l V8 Diesel
...
#ifdef REV_SOUND
#include "sounds/POWERSTROKErev2.h" // Ford Powerstroke 7.3l V8 Diesel
#endif
...
volatile int dieselKnockAdaptiveVolumePercentage = 30; // Adjust the Diesel knock volume for the more silent knocks (usually = 50%)
#include "sounds/POWERSTROKEknock.h" // Ford Powerstroke 7.3l V8 Diesel
