...
volatile int revVolumePercentage = 88; // Adjust the idle volume (usually = 80%, more also working, depending on sound) 104
...
volatile int dieselKnockVolumePercentage = 120; // Adjust the Diesel knock volume (usually = 40 - 120%) 70
...
volatile int turboVolumePercentage = 3; // Adjust the turbo volume (usually = 14%) 3
...
volatile int hornVolumePercentage = 112; // Adjust the horn volume (usually = 80%)
