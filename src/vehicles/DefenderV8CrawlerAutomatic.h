...
#include "sounds/DefenderV8PureSoundIdle.h" // Land Rover Defender V8 crawler
...
//#include "sounds/DefenderV8Rev2.h" // Land Rover Defender V8 (too aggressive)
//#include "sounds/DefenderV8PureSoundRev.h" // Land Rover Defender V8 crawler
#include "sounds/DefenderV8PureSoundRev4.h" // Land Rover Defender V8 crawler
#endif
...
volatile int dieselKnockStartPoint = 300; // Volume will raise above this throttle input( usually 0, for "open pipe" exhaust about 250)
...
uint16_t knockStartRpm = 200; // starting @ this RPM (about 50 - 400)
#endif // ********************************************************************************
