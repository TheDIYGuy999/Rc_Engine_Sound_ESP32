...
#include "sounds/DefenderTd5idle.h" // Land Rover Defender Td5 5 cylinder Diesel
...
#ifdef REV_SOUND
#include "sounds/DefenderTd5rev.h" // Land Rover Defender Td5 5 cylinder Diesel
#endif
...
volatile int dieselKnockVolumePercentage = 22; // Adjust the Diesel knock volume (usually = 40 - 120%)
