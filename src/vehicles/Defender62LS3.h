...
volatile int revVolumePercentage = 150; // Adjust the idle volume (usually = 100%, more also working, depending on sound) 100
...
volatile int dieselKnockVolumePercentage = 750; // Adjust the Diesel knock volume (usually = 200 - 600%) 700
...
volatile int sirenVolumePercentage = 80; // Adjust the siren volume (usually = 100%)
