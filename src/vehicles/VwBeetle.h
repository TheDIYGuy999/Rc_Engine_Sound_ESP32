...
volatile int startVolumePercentage = 56; // Adjust the start volume (usually = 80%)
...
volatile int revVolumePercentage = 56; // Adjust the idle volume (usually = 80%, more also working, depending on sound)
...
volatile int dieselKnockVolumePercentage = 20; // Adjust the Diesel knock volume (usually = 40 - 120%) 10
...
volatile int fanVolumePercentage = 10; // Adjust the fan volume (50% for Tatra 813, else 0%)
