...
#include "sounds/Cat3408newStart.h" // CAT 3408 V8 Diesel start (Kenworth W900A)
...
#include "sounds/Cat3408newIdle.h" // CAT 3408 V8 Diesel idle (Kenworth W900A)
...
volatile int revVolumePercentage = 152; // Adjust the idle volume (usually = 80%, more also working, depending on sound)
...
#include "sounds/Cat3408newRev2.h" // Cabover wit CAT engine rev
...
#include "sounds/Cat3408newKnock2.h" // CAT 3408 V8 Diesel knock (Kenworth W900A)
