...
#include "sounds/FJ40idle.h" // Toyota Fj40 Landcruiser 2F inline 6 petrol
...
#ifdef REV_SOUND
#include "sounds/FJ40rev2.h" // Toyota Fj40 Landcruiser 2F inline 6 petrol
#endif
...
volatile int dieselKnockVolumePercentage = 24; // Adjust the Diesel knock volume (usually = 40 - 120%)
...
#include "sounds/FJ40knock.h" // Toyota Fj40 Landcruiser 2F inline 6 petrol
...
volatile int fanVolumePercentage = 20; // Adjust the fan volume (50% for Tatra 813, else 0%)
