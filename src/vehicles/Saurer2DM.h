...
volatile int idleVolumePercentage = 80; // Adjust the idle volume (usually = 80%, more also working, depending on sound, 40 - 48% if additional diesel knock sound is used) 64
...
volatile int dieselKnockVolumePercentage = 60; // Adjust the Diesel knock volume (usually = 40 - 120%) 50
