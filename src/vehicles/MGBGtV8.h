...
#include "sounds/MGBGtV8start.h" // MGB GT V8
...
#include "sounds/MGBGtV8idle.h" // MGB GT V8
...
volatile int dieselKnockVolumePercentage = 160; // Adjust the Diesel knock volume (usually = 40 - 120%) 50
...
// Clutch parameters ---------------------------------------------------------------------------------------------------
uint16_t clutchEngagingPoint = 120; // CEP. The "clutch" is engaging above this point = engine rpm sound in synch with ESC power
