...
#include "sounds/IS3TankStart.h" // IS-3 tank
...
#include "sounds/IS3TankIdle.h" // IS-3 tank
...
#ifdef REV_SOUND
#include "sounds/IS3TankRev.h" // IS-3 tank
#endif
...
#include "sounds/IS3TankKnock.h" // IS-3 tank
...
volatile int hornVolumePercentage = 0; // Adjust the horn volume (usually = 80%)
