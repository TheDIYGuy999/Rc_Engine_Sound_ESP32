...
#ifdef REV_SOUND
//#include "sounds/1000HpScaniaV8rev.h" // SCANIA V8
//#include "sounds/ScaniaV8motorwayRev.h" // SCANIA V8
#include "sounds/ScaniaV8rev.h" // SCANIA V8 (the best, volume = 120)
//#include "sounds/ScaniaV8raceRev.h" // SCANIA V8 (the 2nd best)
#endif
...
#include "sounds/ScaniaV8knock.h" // SCANIA V8
