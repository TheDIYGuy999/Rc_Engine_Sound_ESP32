...
volatile int startVolumePercentage = 96; // Adjust the start volume (usually = 80%)
...
#include "sounds/TOYOTA12H-Tidle.h" // Toyota Fj40 Landcruiser with 12H Turbo Diesel
...
#ifdef REV_SOUND
#include "sounds/TOYOTA12H-Trev.h" // Toyota Fj40 Landcruiser with 12H Turbo Diesel
#endif
...
volatile int dieselKnockVolumePercentage = 70; // Adjust the Diesel knock volume (usually = 40 - 120%)
...
#include "sounds/TOYOTA12H-Tknock.h" // Toyota Fj40 Landcruiser with 12H Turbo Diesel
...
uint32_t MAX_RPM_PERCENTAGE = 266; // NOTE! Was called TOP_SPEED_MULTIPLIER (TSM) in earlier versions and was a multiplier instead of a percentage!
