...
volatile int dieselKnockVolumePercentage = 170; // Adjust the Diesel knock volume (usually = 40 - 120%) 140
...
volatile int fanVolumePercentage = 6; // Adjust the fan volume (50% for Tatra 813, else 0%)
