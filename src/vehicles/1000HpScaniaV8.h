...
volatile int revVolumePercentage = 64; // Adjust the idle volume (usually = 80%, more also working, depending on sound)
...
volatile int hornVolumePercentage = 96; // Adjust the horn volume (usually = 80%)
