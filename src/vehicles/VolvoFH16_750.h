...
//#include "sounds/FH16_750jakebrake.h" // Volvo FH16 750
#include "sounds/FH16_750jakebrake2.h" // Volvo FH16 750  (more bass)
#endif
...
volatile int dieselKnockVolumePercentage = 56; // Adjust the Diesel knock volume (usually = 40 - 120%)
...
volatile int turboVolumePercentage = 14; // Adjust the turbo volume (usually = 14%)
...
volatile int hornVolumePercentage = 136; // Adjust the horn volume (usually = 80%)
