...
volatile int idleVolumePercentage = 60; // Adjust the idle volume (usually = 80%, more also working, depending on sound, 40 - 48% if additional diesel knock sound is used)
...
volatile int dieselKnockVolumePercentage = 200; // Adjust the Diesel knock volume (usually = 40 - 120%) 140
