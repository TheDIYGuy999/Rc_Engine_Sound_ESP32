...
volatile int dieselKnockVolumePercentage = 50; // Adjust the Diesel knock volume (usually = 200 - 600%)
...
const uint32_t MAX_RPM_PERCENTAGE = 320; // NOTE! Was called TOP_SPEED_MULTIPLIER (TSM) in earlier versions and was a multiplier instead of a percentage!
