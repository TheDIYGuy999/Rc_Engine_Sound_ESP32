...
#include "sounds/ChevyNovaCoupeV8idle.h" // Chevy Nova Coupe V8
...
#ifdef REV_SOUND
#include "sounds/ChevyNovaCoupeV8rev.h" // Chevy Nova Coupe V8
#endif
...
//#include "sounds/ChevyNovaCoupeV8knock.h" // Chevy Nova Coupe V8
#include "sounds/OpenPipeKnock.h" // Extreme V8 petrol open pipe knock
...
const uint8_t escBrakeSteps = 60; // determines, how fast the ESC is able to brake down (20 - 30, 30 for King Hauler)
