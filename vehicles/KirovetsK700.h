...
volatile int startVolumePercentage = 170; // Adjust the start volume (usually = 100%)
...
volatile int dieselKnockVolumePercentage = 180; // Adjust the Diesel knock volume (usually = 200 - 600%)
...
volatile int turboVolumePercentage = 120; // Adjust the turbo volume (usually = 70%)
...
const uint32_t MAX_RPM_PERCENTAGE = 200; // NOTE! Was called TOP_SPEED_MULTIPLIER (TSM) in earlier versions and was a multiplier instead of a percentage!
