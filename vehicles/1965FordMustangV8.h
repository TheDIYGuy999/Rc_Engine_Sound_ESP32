...
volatile int revVolumePercentage = 80; // Adjust the idle volume (usually = 100%, more also working, depending on sound)
...
volatile int dieselKnockVolumePercentage = 170; // Adjust the Diesel knock volume (usually = 200 - 600%)
