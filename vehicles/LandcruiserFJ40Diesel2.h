...
volatile int dieselKnockVolumePercentage = 320; // Adjust the Diesel knock volume (usually = 200 - 600%)
...
volatile int fanVolumePercentage = 20; // Adjust the fan volume (250% for Tatra 813, else 0%)
