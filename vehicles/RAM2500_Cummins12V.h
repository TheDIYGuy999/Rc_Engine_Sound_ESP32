...
volatile int turboVolumePercentage = 60; // Adjust the turbo volume (usually = 70%)
...
const uint32_t MAX_RPM_PERCENTAGE = 340; // NOTE! Was called TOP_SPEED_MULTIPLIER (TSM) in earlier versions and was a multiplier instead of a percentage!
