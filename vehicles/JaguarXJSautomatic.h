...
#include "sounds/JaguarXJSstart.h" // Jaguar XJS V12
...
#include "sounds/JaguarXJSidle2.h" // Jaguar XJS V12
...
#ifdef REV_SOUND
#include "sounds/JaguarXJSrev2.h" // Jaguar XJS V12
#endif
...
volatile int dieselKnockVolumePercentage = 0; // Adjust the Diesel knock volume (usually = 200 - 600%)
