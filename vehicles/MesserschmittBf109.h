...
volatile int dieselKnockVolumePercentage = 10; // Adjust the Diesel knock volume (usually = 200 - 600%)
...
volatile int dieselKnockStartPoint = 200; // Volume will raise above this point ( usually 0, for "open pipe" exhaust about 250)
...
volatile int hornVolumePercentage = 0; // Adjust the horn volume (usually = 100%)
...
volatile int sound1VolumePercentage = 170; // Adjust the sound1 volume (usually = 100%)
...
#include "sounds/MesserschmittBf109Guns.h" // Messerschmitt Bf109 Gun
...
const uint32_t MAX_RPM_PERCENTAGE = 400; // NOTE! Was called TOP_SPEED_MULTIPLIER (TSM) in earlier versions and was a multiplier instead of a percentage!
