...
uint8_t cabLightsBrightness = 100; // Usually 255, 100 for Actros
uint8_t sideLightsBrightness = 150; // Usually 200, 100 for WPL C44, 50 for Landy, 100 for P407
...
uint8_t headlightParkingBrightness = 5; // 0, if you want the headlights being off, if side lights are on, or about 5 if you want them on
