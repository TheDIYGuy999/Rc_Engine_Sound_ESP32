...
// Choose the start sound (not yet implemented)
...
// Choose the horn sound (not yet implemented)
//#include "TrainHorn.h" // The horn
...
// Engine RPM range
#define TOP_SPEED_MULTIPLIER 5 // RPM multiplier: the bigger the number the larger the rev range, 5 is a good place to start (not yet working)
